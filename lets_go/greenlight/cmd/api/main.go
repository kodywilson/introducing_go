...
import (
	...
	"github.com/kodywilson/greenlight/internal/mailer"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "d32e65df50fb42", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "14e457f04e9f50", "SMTP password")
	flag.StringVar(&cfg.smtp.sender, "smtp-sender", "Greenlight <no-reply@greenlight.bob.net>", "SMTP sender")
